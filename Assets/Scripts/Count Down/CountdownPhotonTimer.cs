...
namespace Photon.Pun.UtilityScripts
{
    ...
    public class CountdownPhotonTimer : MonoBehaviourPunCallbacks
    {
        /// <summary>
        ...
        [Header("Coutdown property string")]
        public string CountdownStartTime = "StartTime";
        ...
        public Action<string> OnCountdownUpdated;

        public void Start()
        {
            //if (this.Text[0] == null || this.Text[1] == null) Debug.LogError("Reference to 'Text' is not set. Please set a valid reference.", this);
        }
        ...
        public override void OnEnable()
        {
            ...
            //Debug.Log("OnEnable CountdownTimer" + Countdown);
            base.OnEnable();
        ...
        public void Update()
        {
            ...
            if (text != null)
            {
                text.text = String.Format(FormatText, countdown.ToString("n0"));
            }

            OnCountdownUpdated?.Invoke(string.Format("{0}", countdown.ToString("n0")));
            //Debug.Log(countdown);
        ...
        private void OnTimerEnd()
        {
            ...
            OnCountdownUpdated?.Invoke(string.Empty);
        ...
        //error in function when called directly
        ...
        {
            int startTime;
            bool hasTimeStarted = TryGetStartTime(out startTime);
            this.startTime = startTime;

            if (!hasTimeStarted || TimeRemaining() <= 0)
            {
                SetStartTime();
            }
        }
        ...
        public void RemoveTimer()
        {
            if(PhotonNetwork.CurrentRoom.CustomProperties.ContainsKey(CountdownStartTime))
               PhotonNetwork.CurrentRoom.CustomProperties.Remove(CountdownStartTime);
