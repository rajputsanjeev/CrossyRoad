...
namespace ObserverPattern.Multiplayer
{
    ...
    public class ObstacelObserver : Observer
    {
        ...
        public ObstacelObserver(GameObject boxObj, Movement movement)
        {
            this.boxObj = boxObj;
        ...
        public override void Add(int i, List<Observer> observers)
        {
            Debug.Log("Notify "+ movement.direction +" position " + boxObj.transform.position.x);
